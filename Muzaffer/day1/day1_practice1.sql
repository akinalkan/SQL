...
(                                                                                            
id serial primary key,    --serial id 'yi otomatik arttiriyor                                                                 
isim varchar(20),                                                                            
yas int,                                                                                     
maas int,                                                                                    
email varchar(30)                                                                            
...
select *
from personel
where email !~~* '%gmail.com%' or email is null;

--11) id'si 3,5,7 ve 9 olan personel bilgilerini listeleyiniz.
select *
from personel
where id in(3,5,7,9);--in kullanimi : benzer ifadeleri alirken kullanilir
